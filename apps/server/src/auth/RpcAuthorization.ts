...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.gitStageFile]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitUnstageFile]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitDiscardFile]: AuthOrchestrationOperateScope,
